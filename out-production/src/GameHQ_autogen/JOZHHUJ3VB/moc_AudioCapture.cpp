...
#include "../../../../src/capture/AudioCapture.h"
...
void AudioCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AudioCapture::*)(const QString & );
            if (_q_method_type _q_method = &AudioCapture::errorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioCapture::errorOccurred(const QString & _t1)
{
